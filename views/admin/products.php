  ...
  <div class="row">
    ...
    <nav class="col-md-2 d-none d-md-block sidebar py-3">
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="<?= $root ?>/views/admin/products.php" class="nav-link active" >Quản lý sản phẩm</a></li>
        <li class="nav-item mb-2"><a href="<?= $root ?>/views/admin/categories.php" class="nav-link">Quản lý danh mục</a></li>
    ...
    <main class="col-md-10 ms-sm-auto px-4">
      <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
        ...
        <a href="<?= $root ?>/views/admin/add_product.php" class="btn btn-success">Thêm sản phẩm</a>
      </div>
      ...
      <table class="table table-hover table-bordered align-middle">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $p['description'] ?></td>
            <td><img src="<?= $root ?>/<?= $p['image']?>" width="70"></td>
            <td><?= $p['stock'] ?></td>
            <td><?= $p['id_categories'] ?></td>
            <td>
              <a href="<?= $root ?>/views/admin/edit_product.php?id=<?= $p['id_products'] ?>" class="btn btn-sm btn-primary">Sửa</a>
              <a href="<?= $root ?>/views/admin/delete_product.php?id=<?= $p['id_products'] ?>" onclick="return confirm('Bạn chắc chắn muốn xóa')" class="btn btn-sm btn-danger">Xóa</a>
            </td>
          </tr>
          <?php endforeach;?>
        </tbody>
