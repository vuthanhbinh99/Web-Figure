    ...
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar py-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="<?= $root?>/views/admin/orders.php" class="nav-link active">Quản lý đơn hàng</a></li>
            </ul>
        </nav>
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php foreach ($orders as $o): ?>
                    <tr>
                        ...
                        <td><?= $o['created_at'] ?></td>
                        <td>
                            <a href="<?= $root ?>/views/admin/order_detail.php?id=<?= $o['id_order'] ?>" class="btn btn-sm btn-primary">Xem</a>
                            <a href="<?= $root ?>/views/admin/update_order.php?id=<?= $o['id_order'] ?>" class="btn btn-sm btn-warning">Sửa</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
