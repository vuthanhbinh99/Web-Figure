...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-10 ms-sm-auto px-4 py-4">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card product-card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <a href="edit_product.php?id=<?= $p['id_products'] ?>" class="btn btn-sm btn-primary w-100 mb-1">Sửa</a>
                                <a href="delete_product.php?id=<?= $p['id_products'] ?>" class="btn btn-sm btn-danger w-100" onclick="return confirm('Bạn có chắc muốn xóa?')">Xóa</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
        ...
        <h3 class="mt-5 mb-3">Danh mục</h3>
        <ul class="list-group">
            <?php foreach($categories as $c): ?>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?= $c['name'] ?>
                    <span>
                        <a href="edit_category.php?id=<?= $c['id_categories'] ?>" class="btn btn-sm btn-primary">Sửa</a>
                        <a href="delete_category.php?id=<?= $c['id_categories'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc muốn xóa?')">Xóa</a>
                    </span>
                </li>
            <?php endforeach; ?>
        </ul>
